...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700,700i%7CRajdhani:400,600,700"
        rel="stylesheet">
    <!-- Plugins Stylesheets -->
    <link rel="stylesheet" href="bootstrap/assets/css/loader/loaders.css">
    <link rel="stylesheet" href="bootstrap/assets/css/font-awesome/font-awesome.css">
    <link rel="stylesheet" href="bootstrap/assets/css/bootstrap.css">
    <link rel="stylesheet" href="bootstrap/assets/css/aos/aos.css">
    <link rel="stylesheet" href="bootstrap/assets/css/swiper/swiper.css">
    <link rel="stylesheet" href="bootstrap/assets/css/lightgallery.min.css">
    <!-- Template Stylesheet -->
    <link rel="stylesheet" href="bootstrap/assets/css/style.css">
    <!-- Responsive Stylesheet -->
    <link rel="stylesheet" href="bootstrap/assets/css/responsive.css">
</head>
...
<body>
    ...
    <header class="position-absolute w-100">
        <div class="container">
            <div class="top-header d-none d-sm-flex justify-content-between align-items-center">
                <div class="contact">
                    <a href="#" class="tel"><i class="fa fa-phone" aria-hidden="true"></i>01000000000</a>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="index.html"><img src="bootstrap/assets/images/Elogo.PNG" alt="Multipurpose"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="single-widget recent-post-widget" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="bootstrap/assets/images/rcnt-post1.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="bootstrap/assets/images/rcnt-post2.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="bootstrap/assets/images/rcnt-post3.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
                            ...
                            <div class="media">
                                <a class="rcnt-img" href="#"><img src="bootstrap/assets/images/rcnt-post4.png"
                                        alt="Recent Post"></a>
                                <div class="media-body ml-3">
    ...
    <!-- Footer Endt -->
    <!--jQuery-->
    <script src="bootstrap/assets/js/jquery-3.3.1.js"></script>
    <!--Plugins-->
    <script src="bootstrap/assets/js/bootstrap.bundle.js"></script>
    <script src="bootstrap/assets/js/loaders.css.js"></script>
    <script src="bootstrap/assets/js/aos.js"></script>
    <script src="bootstrap/assets/js/swiper.min.js"></script>
    <script src="bootstrap/assets/js/lightgallery-all.min.js"></script>
    <!--Template Script-->
